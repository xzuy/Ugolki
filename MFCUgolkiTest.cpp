...
// MFCUgolkiTest.cpp: определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CMFCUgolkiTestApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// Создание CMFCUgolkiTestApp

CMFCUgolkiTestApp::CMFCUgolkiTestApp()
{
...
// Единственный объект CMFCUgolkiTestApp

CMFCUgolkiTestApp theApp;


// Инициализация CMFCUgolkiTestApp

BOOL CMFCUgolkiTestApp::InitInstance()
{
